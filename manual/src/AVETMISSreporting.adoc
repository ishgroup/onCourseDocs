...
image::images/AVETMISS_export_GUI.png[ Review the numbers on this screen before exporting. It can help you find any issues earlier than usual]
...
image::images/AVETMISS_overview.png[ Ensure you select the right 'AVETMISS flavour' for the export]
...
image::images/AVETMISS_export_overview.png[ A breakdown of your export as it appears before you create the NAT files]
...
image::images/funding_upload.png[ The funding upload window showing the history of AVETMISS exports run]
...
image::images/outcome_funding_uploads.png[ Enter your State Funding Source code in the field highlighted.]
...
image::images/Class_State_funding.png[ Enter your State Funding Source code in the field highlighted.]
...
image::images/Adding_outcome.png[ Adding an additional Outcome via the student's Enrolment record.]
