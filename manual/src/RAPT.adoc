...
image:images/rapt_export.png[ WA RAPT reporting options,scaledwidth=100.0%]
...
image:images/rapt_export_class.png[ Selecting a group of classes to run the RAPT export against,scaledwidth=100.0%]
...
+
image:images/export_CQR_report.png[ Selecting the CQR report in the list view of the Certificates window,scaledwidth=100.0%]
. Your files will be saved in a folder in the location you have chosen.
Locate your files and then upload them to TAC

image:images/certificate_export.png[ View of the CQR report,scaledwidth=100.0%]
