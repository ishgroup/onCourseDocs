...
image::images/Windows_2003_system_properties.png[image]
...
image::images/onCourse_LDAP_AD_screen_setup.png[image]
...
image::images/LDAP_AD_authorisation_settings.png[image]
