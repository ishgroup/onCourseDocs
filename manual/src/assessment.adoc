...
The record contains the student name, class name, assessment task name, two checkboxes for 'submitted' and 'marked', a grade field fro grading, a date field for each checkbox, and notes and documents.
