...
image::images/payment_plan_class_block.png[ Payment plan detail explained in the class web info]
...
image::images/payment_plan_pay_now.png[ Pay now reduced to the applicable payment plan deposit]
...
image::images/payment_plan_script.png[ 'send payment plan reminder' script]
...
image::images/payment_plan_email_template.png[ 'Payment reminder' message template]
...
image::images/store_card.png[ Click 'Store Card' to store the card for later use]
...
image::images/batch_payments.png[ The Batch Payments In window showing 14 payments overdue]
...
image::images/batch_payments_detail.png[ This contact owes money on two invoices,but only one will have a payment attempted on it]
...
image::images/batch_payment_running.png[ While running,each payment will display a 'processing' icon]
...
image::images/batch_payments_results.png[ The results after processing 6 payments; 1 failed,5 successful]
