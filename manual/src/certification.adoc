...
image::images/certificate_window.png[ Certificate list view - this is the register of all certificates created,printed and revoked in your organisation]
...
image::images/certificate_edit_view.png[ Certificate edit view in full screen mode]
...
image::images/EditSignatoryNameViaAVETMISSTab.png[ Updating signatory name via General Preferences]
...
image::images/reports/print_with_qr_code.png[ Printing a certificate with the QR code option enabled]
...
image::images/skillset_certificate_set_up.png[A Skill Set certificate record]

image::images/reports/soaskillset.png[ Statement of Attainment layout for a Skill Set Certificate without a background]
...
image::images/vet_cert_email.png[ Email to notify the student their certificate is available]

image::images/portal_feedback.png[ After clicking on the link in the email the student can provide feedback]

image::images/reports/vet_soa_email_sample.png[ Statement of Attainment PDF available in the portal for the student to download or print]
...
+
image::images/saving_a_certificate_on_your_computer.png[ Saving a certificate to your computer]
. Find the enrolment you want to attach the certificate in the enrolments list view.

image::images/enrolment_list_view.png[image]
. Open the enrolment record and click the + button next to the Documents heading.

image::images/enrolment_edit_view_attachments_tab.png[ Attaching the certificate to the enrolment record]
...
image::images/attaching_certificate_enrolment.png[image]
...
image::images/adjust_script_attendance.png[ Changes made to the default script rules to check for a 75% attendance before issuing the certificate]
...
image::images/print_certificate_attendance_with_background.png[ Selecting and printing a Certificate of Attendance with the specified background for this script]

Print and test your report layout, and if it is successful it will look something like this:

image::images/certificate_attendance_with_background.png[ A sample Certificate of Attendance printed with a custom background]
...
image::images/certificate_attendance_available_survey_HTML.png[ A sample email advising the student their certificate is available after completing the survey]
