...
For more information about the budget section, and tracking expenditure and income for classes, visit <<budgets>>.
...
Attendance is the section where you not only mark student and tutor attendance, but for VET classes this is also where you set your class training plan.
