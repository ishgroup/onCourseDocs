...
Memberships show the memberships sold to the user, inluding who it was purchased by , when it was purchased, the valid to and from dates, the price and the status.
