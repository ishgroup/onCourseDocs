...
====
+
. Search results will appear and will auto-filter the more you type. Click the 'Add' button to the right of a selection to add it as a relation, then make sure you click Save to save the changes.
+
