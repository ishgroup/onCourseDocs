...
image::images/course_list_view.png[ The course list view showing the core filters and tag filters]
...
image::images/course_traineeship.png[ The Traineeship field already ticked. It cannot be unticked once you've taken an enrolment in a related class.]
...
image::images/AddingRelatedCourseEditView.png[ Adding Related Courses and Products]
...
image::images/quals_3column_view.png[ The Qualifications/Units of Competency window in three-column view mode]

image::images/quals_listview.png[ The Qualifications/Units of Competency window in list view mode]
...
showing a full qualification with selected units]
...
image::images/bulk_online_courses.png[ The bulk edit view uses the same styling as sharing does. A checked box puts the classes online,unchecked removes them.]
