...
image::images/course_traineeship.png[title='The Traineeship checkbox']
...
image::images/course_graph_places.png[title='A graph of places available across all classes in this course.']
