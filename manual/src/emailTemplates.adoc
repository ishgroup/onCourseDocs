...
image::images/email_template.png[ The "course completion survey" template window]
...
image::images/send_custom_email.png[ Select 'Send Message' to send a template message]
