...
https://mailchimp.com/help/about-api-keys/. Go to Account > Extras > API
keys > Create a key (under Your API Keys header)
. In MailChimp, find your the Audience Id at
https://mailchimp.com/help/find-audience-id/ Go to the Audience page >
Settings, and scroll to find the unique List ID field
...
Insert your API key and Audience (List) ID from MailChimp, then save and
close this window.
+
