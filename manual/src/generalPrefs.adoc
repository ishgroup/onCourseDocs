...
image::images/class_defaults_tab.png[image]
...
image::images/fundingcontracts_prefs.png[Funding Contracts in the General Preferences window]
...
image::images/holiday_error_message.png[image]
...
image::images/PaymentTypesPreferences.png[ The "Payment types" Preferences]
...
image::images/voucher_edit.png[ Voucher]
...
image::images/ConcessionTypesPreferences.png[ The "Concession types" Preferences]
...
image::images/ContactRelationTypesPreferences.png[ The "Contact relation types" Preferences]
...
image::images/CustomFieldsPreferences.png[ The "Custom fields" Preferences]
...
image::images/CFDropDownOptions.png[ Clicking on the custom field drop down options in the contact record]
...
image::images/delete_custom_field.png[ For the user to delete this cutom field they must type out Study Reason exactly,then hit Delete]
