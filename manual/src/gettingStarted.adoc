...
Your favourites will always appear at the top of the global navigation, and it will _always_ contain Checkout.
...
[[gettingStarted-contactInsights]]
=== Contact Insights
...
image::images/dashboard_contact_insights.png[title='The contact insights panel']
...
image::images/insights_icon.png[title='Click this icon anywhere you see it to open the contact insights panel for that contact']
...
image::images/mandatory_fields_error.png[title='The Save button showing there is some information missing, and the offending field is highlighted in red']
