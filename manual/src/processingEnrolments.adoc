...
+
image::images/autocomplete.png[ Use the auto complete to locate and select the student]
...
image::images/concessions1.png[ Enrolment with an automatic discount applied for one class]
...
image::images/Prom_code.png[ The Checkout promotional code field before entering the code]

image::images/Prom_code2.png[ After entering the code,the system will automatically apply any discount matching the code and add it to the Summary. Here the promotion was called Combo 1]
...
image::images/checkout_price_adjust_discount.png[ This enrolment has the 'early bird discount' applied,and is having its price manually edited to $100]
...
+
image::images/QE_multiple_class.png[ Both students are selected to attend these classes,with the company selected as Payer]
...
image::images/reports/funding_invoice.png[ Funding invoice in the Checkout]
...
image::images/QE_payment_options.png[ Payment options available via Checkout]
...
image::images/QE_credit_card_payment_window.png[ Secure credit card payment window to process credit card payments]
...
image::images/Successful_CC_Payment_Message.png[ Transaction successful screen in the Checkout]
...
image::images/checkout_failed_payment.png[ A failed payment in the Checkout]
...
+
image::images/List_of_outstanding_invoices.png[ List of outstanding invoices and the Pay Now amount showing the amount to be paid]
...
image::images/payments_in_batch.png[ How to process batch payments vis Payments In window]
...
image::images/QE_send_notifications.png[ Sending an enrolment confirmation and invoice through Checkout]
...
image::images/update_outcomes_from_enrolment.png[ Enrolment general tabs show a number of fields that use default values]
...
image::images/add_override_enrolment_fields.png[ Enrolment general tabs show a number of fields that use default values]
...
image::images/QE_age_restriction_error_message.png[ Checkout showing age restriction message]

image::images/age-restrict-checkout.png[ Checkout showing missing DOB message when enrolling in a class with age restrictions]
