...
You can add your own custom reports to onCourse at any time by creating them with https://community.jaspersoft.com/release/jaspersoft-studio-631[JasperSoft Studio].
