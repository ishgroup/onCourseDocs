...
link:courses.xml#courses[Courses chapter] to understand the basics of what a course is in onCourse, and how to go about creating one.
...
For a detailed view on how to create a new course in onCourse,
...
You can learn how to do this link:classes.xml#classes[in our Classes chapter].
