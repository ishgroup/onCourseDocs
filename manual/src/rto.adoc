...
image::images/vet_course_tab.png[ The VET tab of the course,showing a full qualification with selected units]
...
image::images/computing_basics.png[ 1st course: The Qualification is attached to the course,but the student has not completed any units of competency by completing this course]

image::images/understanding_computer_basics.png[ 2nd course: The Qualification and Units are attached to this course. After completing part 1 and 2 the student can now be assessed.]

image::images/vet_student_outcomes.png[ This student record shows a 'dummy' outcome for the course with no units. They have completed it successfully. Now they can be assessed against the other units.]
...
+
image::images/assessment/timetable_training_plan.png[ Select all outcomes for delivery per session. In this example,Both BSBWOR203 and SITHFAB002 will be taught in the first session on the 24th March.]
...
image::images/reports/TrainingPlanPageOne.png[ The 3rd page of the Training Plan starts the list of outcomes with visible start and end dates.]
...
image::images/reports/funding-invoice-display.png[ Funding invoice in detail showing the invoices lines with student name and class name.]
