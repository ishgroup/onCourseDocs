...
args.loggedInUser::
This is the object which contains data about user, that triggered this script. Don't use it into scripts, that are not triggered by hand. The most useful fields are loggedInUser.email, loggedInUser.firstName, loggedInUser.lastName
