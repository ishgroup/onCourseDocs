...
. *historic aged debtors* - this export will prompt the user for a date and produce a CSV file with debtors as at that date, aged by 30 periods and taking into account payment plans.
