...
They can all be found in our link:GitHub documentation.[GitHub documentation.]
...
. *Membership notification renewal*- This script will send an email (template - Membership Notification Renewal) to each contact with an active membership 7 days prior to it's expiry to remind them to purchase a renewal.
...
For more information about 3rd party application integrations refer to the chapter
