...
image::images/send_payment_receipt_script.png[ Example of what a script looks like]
...
image::images/script_list_view.png[ Scripts as they appear in the Automation window]
...
image::images/on_demand_dashboard.png[ Look for the above icon after clicking 'Edit' on the main dashboard navigation.]
