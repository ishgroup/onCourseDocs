...
image::images/search/find_related_records.png[ Finding the related Course record for the highlighted Class]
...
image::images/search/searchOperator.png[ An example of a simple query using the onCourse query language]
...
image::images/search/advanced_query_fields.png[ Query parameters are listed in a simple,context-sensitive drop-down box for you to choose from]
...
image::images/search/searchScript.png[image]
