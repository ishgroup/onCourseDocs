...
image::images/reset_admin_site_login.png[ Switching the administration centre]
...
image::images/require_password_change.png[When your administrator requests a new password,you'll see this screen]
...
image::images/password_minimum_requirements.png[ The prompt asking for a more secure password]
...
image::images/user_already_logged_in.png[ Users who try and log in twice concurrently will see this screen]
...
image::images/security_user_roles.png[Access rights can be set individually for each user role]
...
image::images/2fa_notification.png[ Login window]
...
image::images/enter_2fa_code.png[ Window you see when trying to enable your own two factor authentication]
...
image::images/googleAuthenticatorApp.png[ Install Google Authenticator on your smart phone]
...
image::images/Disable_two_factor_authentication_message.png[ Message window you see when trying to disable your own two factor authentication]
