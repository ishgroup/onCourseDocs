...
image::images/waitlist_with_class.png[A course with a class available and a waitlist option]
...
image::images/man_waiting_list.png[A waiting list record]
...
image::images/waitinglist_tagging.png[ Tagging a contact in the Waiting List to the tag 'Awaiting reply']
...
image::images/waitinglist_filter.png[ Viewing a list of all the contacts on a Waiting List that are tagged to 'Awaiting reply']
...
image::images/advising_student.png[image]
