...
+
image::images/demo_login_screen.png[ In the onCourse demo,use the username and password provided above. For your own college,use your email address and the password provided to by your college administrator.]
...
+
image::images/2fa_notification.png[ This two-factor authentication page will appear every time you open onCourse until it has been enabled on the account accessing the system]
...
+
image::images/dashboard_blog.png[ If you make it to this screen you have logged in successfully. Well done!]
