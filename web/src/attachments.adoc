...
image::images/upload_image_to_course.png[ Upload a document to your course via the web page of the given course]
...
image::images/tagged_image_course_details.png[ Tagged image displayed at the top of the Accounting course detail page]

You would then create a new tag group called 'image' and a tag inside that group. Call that tag 'hero'.

image::images/taggingheroimage.png[ Creating a new tag group called 'image' and a child tag called 'hero']
...
image::images/tagged_image_course.png[ Added the image 'dart' to the course 'Accounting']
