...
Because onCourse has been written as one comprehensive system, updating your website is completely autoamted and painless.
...
This means for example that as courses are filled, the website automatically updates to show prospective students that places are limited.
...
Check the onCourse manual for more on
