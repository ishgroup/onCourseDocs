...
*Allow create new student on enrol* - allows new student records to be created by users on the website. Disable this if you only want to allow students you or your staff have added to onCourse to use the checkout.

*Allow create new student waiting list* - allow students without a contact record in your system to create a new student record when putting themselves on a waiting list.

*Allow create new student mailing list* - allow students without a contact record in your system to create a new student record when putting themselves on a waiting list.
...
*Enrolment min age* - Whatever is set in this field is the absolute minimum age a contact must be in order to enrol on your website.
