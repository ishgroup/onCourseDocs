...
link:tutors.html#tutor_outcome_marking[tutor instructions] or edit them to include your own process with the specific steps and setting for your college.
