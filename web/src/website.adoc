...
==== Distance to suburb
    /courses?near=Chatswood/2067/1

Search on the Suburb/postcode/search radius in km. While the search may work without the postcode, adding the postcode is essential for some suburbs which are not unique in your country. If you skip the search radius, all results within 100km will be returned with the closest sorted to the top. If you include the radius, then results further away will be completely excluded from the results.
