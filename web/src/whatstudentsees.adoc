...
* A field to enter promotional codes, gift certificates or vouchers (more information on this can be found in link:#paymentoptions[payment
options chapter])
...
This process works via pre-approval and it can't just be chosen by any visitor to the website (more information on this can be found in the link:#paymentoptions[payment options
chapter]).
